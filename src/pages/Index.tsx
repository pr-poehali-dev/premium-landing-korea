...
const advantages = [
  ...
  { icon: 'MessagesSquare', title: 'Русскоязычная поддержка', text: 'Всегда на связи, чтобы помочь с любыми вопросами в Южной Корее.' },
...
const steps = [
  ...
  { n: '05', icon: 'Plane', title: 'Прилёт', text: 'Прилетаете в Южную Корею' },
...
const vacancies = [
  ...
  },
  {
    ...
    img: 'https://cdn.poehali.dev/projects/d63b7d85-0f3e-4b08-ad0a-e351e4372f3c/files/32603f94-71d5-4400-9397-14ac242acd13.jpg',
  },
  {
    title: 'Сотрудник склада',
    salary: '3 200 000 ₩/мес',
    region: 'Инчхон',
    details: ['Проживание не предоставляется', 'Питание — обед'],
    img: 'https://cdn.poehali.dev/projects/d63b7d85-0f3e-4b08-ad0a-e351e4372f3c/files/cd7a600a-d7b0-4b8a-af98-9680cc24535d.jpg',
  },
];

const reviews = [
  { name: 'Алексей М.', role: 'Конная ферма, Куми', text: 'Помогли с визой и жильём за две недели. Всё прошло чётко и без лишних вопросов.' },
  { name: 'Динара К.', role: 'Кухонный работник, Сеул', text: 'Поддержка на русском очень выручила. Чувствовала себя спокойно на всех этапах.' },
  { name: 'Сергей П.', role: 'Почтовый склад, Инчхон', text: 'Зарплата как обещали, условия проживания отличные. Рекомендую без сомнений.' },
];
...
const faq = [
  ...
  { q: 'Как быстро можно выехать?', a: 'Срок зависит от вакансии, документов и даты ближайшего рейса. Мы стараемся организовать выезд в максимально короткие сроки.' },
];
        ...
        <div className="container relative mx-auto px-6">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-xl text-lg text-white/70 animate-fade-up" style={{ animationDelay: '120ms' }}>
              Берём на себя все организационные вопросы: подбор вакансии, оформление K-ETA и визы G1, поиск жилья и сопровождение после приезда.
            </p>
